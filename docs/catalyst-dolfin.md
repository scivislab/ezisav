...
The Catalyst pipelines can be changed by editing [feslicescript.py](https://github.com/scivislab/ezisav/tree/main/catalyst/Examples/CxxFullExample/SampleScripts/feslicescript.py) for the grid example or [CatalystScriptTest.py](https://github.com/scivislab/ezisav/tree/main/catalyst/Examples/PythonDolfinExample/CatalystScriptTest.py) for the DOLFIN example. 
